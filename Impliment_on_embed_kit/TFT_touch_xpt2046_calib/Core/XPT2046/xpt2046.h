...
#define XPT2046_X_OFFSET 		12
#define XPT2046_Y_OFFSET		-16

#define XPT2046_WIDTH			240
#define XPT2046_HEIGHT			320
/* This pins must be defined as in your project */
#define TOUCH_CS_GPIO_Port		T_CS_GPIO_Port
#define TOUCH_CS_Pin			T_CS_Pin
#define TC_PEN_GPIO_Port		T_IRQ_GPIO_Port
#define TC_PEN_Pin				T_IRQ_Pin
